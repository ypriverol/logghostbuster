...
\small Deepti J Kundu, Nithu Sara John, Marc Riera Duocastella,\\
\small Juan Antonio Vizca\'{i}no, Yasset Perez-Riverol
}
\date{}
...
Figure~\ref{fig:agreement_supp} shows pairwise agreement between methods. Rules and Deep agree on 87.8\% of classifications (Cohen's $\kappa$ = 0.51), indicating moderate agreement. Per-category agreement is highest for organic classification and lowest for hubs.
